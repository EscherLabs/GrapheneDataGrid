...
function tableModel(t,i,e){this.visible=!1,this.owner=t,this.id=gform.getUID(),this.attributes={},this.display={},this.attribute_history=[],this.schema=t.options.schema,this.iswaiting,this.row=document.createElement("tr"),this.row.setAttribute("data-id",this.id),this.row.setAttribute("class","filterable grid-row"+(this.iswaiting?" warning":"")),this.waiting=function(t){return void 0!==t&&(this.iswaiting=t,this.row.setAttribute("class","filterable grid-row"+(this.iswaiting?" warning":"")),this.draw()),this.iswaiting},this.draw=function(){if(this.visible){var t=gform.renderString(this.owner.view,this);this.row.innerHTML!=t&&(this.row.innerHTML=t)}return this.row},this.eventBus=new gform.eventBus({owner:"model",item:"model",handlers:e||{}},this),this.on=this.eventBus.on,this.dispatch=this.eventBus.dispatch;var s=function(){_.each(this.schema,function(t){if(void 0!==t.options){var i;if(void 0!==t.value_key)if("index"==t.value_key)i=t.options[this.attributes[t.name]];else{var e={};e[t.value_key]=this.attributes[t.name],i=_.find(t.options,e),_.isFinite(this.attributes[t.name])&&(e[t.value_key]=parseInt(this.attributes[t.name]),void 0===i&&(i=_.find(t.options,e)),void 0===i&&(i=_.find(t.options,e)))}else void 0===(i=_.find(t.options,{value:this.attributes[t.name]}))&&(i=_.find(t.options,{id:this.attributes[t.name]})),_.isFinite(this.attributes[t.name])&&(void 0===i&&(i=_.find(t.options,{value:parseInt(this.attributes[t.name],10)})),void 0===i&&(i=_.find(t.options,{id:parseInt(this.attributes[t.name],10)})));this.display[t.name]="object"==typeof i?i[t.label_key]||i.label||i.name:this.attributes[t.name]}else t.template?this.display[t.name]=gform.renderString(t.template):this.display[t.name]=this.attributes[t.name]}.bind(this))};this.set=function(t,i){void 0!==t&&(this.attribute_history.push(_.extend({},this.attributes)),this.attributes=t),s.call(this),this.draw(),i||this.dispatch("set")},this.checked=!1,this.deleted=!1,this.toggle=function(t,i){this.checked="boolean"==typeof t?t:!this.checked,this.draw(),i||this.dispatch("check")},this.set(i),s.call(this),this.toJSON=function(){return this.attributes},this.undo=function(){this.deleted?(this.deleted=!1,this.owner.draw()):this.attribute_history.length&&(this.attributes=this.attribute_history.pop(),s.call(this),this.owner.draw())},this.delete=function(){this.deleted=!0}}
