var gform = function (optionsIn, el) {
            ...
            if (field.array && _.isArray(item)) {
              ...
              if (list.length > 1) {
                _.each(list.slice(1), function (field) {
                  var index = _.findIndex(field.parent.fields, {
                    id: field.id,
                  });
              ...
              gform.inflate.call(
                ...
                attr,
                field,
                _.findIndex(field.parent.fields, { id: field.id }),
                field.parent.fields
              );
              // }

              var fieldCount = this.filter({
                array: { ref: field.array.ref },
              }).length;
              ...
              _.each(
                field.operator.container.querySelectorAll(".gform_isArray"),
                testFunc.bind(
                  null,
                  '[data-ref="' + field.array.ref + '"] .gform-add',
                  fieldCount >= (field.array.max || 5)
                )
              );
              _.each(
                field.operator.container.querySelectorAll(".gform_isArray"),
                testFunc.bind(
                  null,
                  '[data-ref="' + field.array.ref + '"] .gform-minus',
                  !(fieldCount > (field.array.min || 1))
                )
              );
  ...
  this.listener = function (e) {
    ...
    if (e.target.classList.contains("gform-add")) {
      ...
      var fieldCount = _.filter(field.parent.fields, function (o) {
        return (
      ...
      if (field.editable && fieldCount < (field.array.max || 5)) {
        ...
        field.operator.reflow();
        _.each(
          _.filter(field.parent.fields, function (o) {
            return (
              o.name == field.name &&
              typeof o.array !== "undefined" &&
              !!o.array
            );
          }),
          function (item, index) {
...
gform.inflate = function (atts, fieldIn, ind, list) {
  ...
  if (fieldIn.array) {
    newList = _.filter(newList, function (item) {
      return !item.index;
    });
  }
  ...
  if (field.array) {
    ...
    var initialCount = _.filter(field.parent.fields, function (o) {
      return (
        o.name == field.name && typeof o.array !== "undefined" && !!o.array
      );
    }).length;
    ...
    // _.each(field.operator.container.querySelectorAll('[data-ref="'+field.array.ref+'"] .gform-minus'),testFunc.bind(null,!(fieldCount > (field.array.min || 1) ) ))
    var fieldCount = field.operator.filter({
      array: { ref: field.array.ref },
    }).length;
...
gform.normalizeField = function (fieldIn, parent) {
  ...
  if (typeof gform.types[fieldIn.type] == "undefined") {
    console.warn(
      'Field type "' + fieldIn.type + '" not supported - using text instead'
    );
    fieldIn.type = "text";
  }
  ...
  var field = _.assignIn(
    {
      ...
      label:
        fieldIn.legend ||
        fieldIn.title ||
        (gform.types[fieldIn.type] || gform.types["text"]).defaults.label ||
        fieldIn.name,
      validate: [],
      valid: true,
      parsable: true,
  ...
  if (
    typeof field.multiple == "undefined" &&
    typeof field.limit !== "undefined" &&
    field.limit > 1
  ) {
    field.multiple = true;
  }
  field.name =
    field.name ||
    (gform.renderString(fieldIn.label || fieldIn.title) || "")
      .toLowerCase()
      .split(" ")
      .join("_");
  ...
  if (field.fillable) {
    if (!this.options.strict) {
      if (
        ...
        field.value = _.defaults(
          { value: atts[field.name] },
          { value: field.owner.options.data[field.name] },
          field
        ).value;
      }
    } else {
  ...
  if (field.item.value !== 0) {
    if (field.array && typeof atts[field.name] == "object") {
      ...
      if (
        ...
        field.value = field.derivedValue.call(f, {
          form: field.owner,
          field: field,
        });
        field.owner.on(
        ...
        if (field.fillable) {
          field.value = _.defaults({ value: atts[field.name] }, field, {
            value: "",
          }).value;
        }
      }
...
gform.reflow = function () {
  if (
    this.isActive ||
    (typeof this.owner !== "undefined" && this.owner.isActive)
  ) {
    _.each(
      this.rows,
      function (item, i) {
    ...
    toString: function (name, report) {
      if (!report) {
        return (
          "<h4>" +
          this.label +
          '</h4><hr><dl style="margin-left:10px">' +
...
gform.types["output"] = _.extend({}, gform.types["input"], {
  ...
  render: function () {
    this.display = gform.renderString(
  ...
  if (typeof conditions === "string") {
    ...
    if (
      ...
      if (
        ...
        func.call(
          this,
          this.owner.methods[conditions.split("method:")[1]].call(this, {
            form: this.owner,
            field: this,
          }),
  ...
  toString: function (name, display) {
    if (!display) {
      return (
        "<dt>" +
        this.label +
        '</dt> <dd><span style="width:20px;height:20px;display: inline-block;top: 5px;position: relative;background:' +
        this.value +
        ';"></span> ' +
        (this.value || "(empty)") +
        "</dd><hr>"
...
gform.types["smallcombo"] = _.extend({}, gform.types["input"], {
  ...
  get: function () {
    if (this.strict) {
      return (_.find(this.options, { value: this.value }) || { value: "" })
        .value;
    } else {
      return this.value;
    }
  ...
  initialize: function () {
    ...
    this.processOptions = function (item) {
      if (typeof item.optgroup !== "undefined") {
        if (
          typeof item.optgroup.options !== "undefined" &&
          item.optgroup.options.length
        ) {
        ...
        if (
          ...
          li.innerHTML = gform.renderString(
            '<a href="javaScript:void(0);" data-index="{{i}}" class="dropdown-item">{{{display}}}{{^display}}{{{label}}}{{/display}}</a>',
            item
          );
                ...
                function (option) {
                  ...
                  if (typeof this.format !== "undefined") {
                    if (typeof this.format.label !== "undefined") {
                      option.label = gform.renderString(
                        this.format.label,
                        option
                      );
                    }
                    if (typeof this.format.display !== "undefined") {
                      option.display = gform.renderString(
                        this.format.display,
                        option
                      );
                    }
                    if (typeof this.format.value !== "undefined") {
                      option.value = gform.renderString(
                        this.format.value,
                        option
                      );
                    }
    ...
    if (typeof this.search == "string") {
      gform.ajax({
        path: gform.renderString(this.search, { value: this.value }),
        success: function (data) {
          index = this.options.length;
            ...
            _.map(
              ...
              function (option) {
                ...
                if (
                  ...
                  var li = document.createElement("li");
                  li.innerHTML = gform.renderString(
                    '<a href="#" data-index="{{i}}" class="dropdown-item">{{{display}}}{{^display}}{{{label}}}{{/display}}</a>',
                    option
                  );
                  this.menu.appendChild(li);
                }
