...
gform.processConditions = function(conditions, func) {
	if (typeof conditions === 'string') {
		...
		if(typeof conditions !== 'undefined' && conditions.indexOf('method:') == 0){
			if(typeof this.owner.methods !== 'undefined' && typeof this.owner.methods[conditions.split('method:')[1]] == 'function'){
				func.call(this, this.owner.methods[conditions.split('method:')[1]].call(this,{form:this.owner,field:this}),{form:this.owner,field:this})
			}
		}
	}
	...
	if (typeof conditions === 'function') {
		func.call(this, conditions.call(this,{form:this.owner,field:this}),{form:this.owner,field:this})
	}
